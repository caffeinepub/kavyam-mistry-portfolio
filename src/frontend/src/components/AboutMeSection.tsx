    ...
    <section className="mb-8">
      ...
      <div className="minecraft-box-large">
        ...
        <div className="text-gray-300 leading-relaxed text-lg space-y-4">
          <p>
            I'm a skilled Minecraft developer and server moderator with
            experience over{" "}
            <span className="text-cyan-400 font-semibold">3.5+ years</span> and
            also did developing in big servers. I specialize in plugin
            configuration, full server setup, and general moderation.
          </p>
