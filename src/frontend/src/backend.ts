...
import type { AuthRole as _AuthRole, RegisterResult as _RegisterResult, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async authenticate(arg0: string, arg1: string): Promise<AuthRole> {
        if (this.processError) {
            try {
                const result = await this.actor.authenticate(arg0, arg1);
                return from_candid_AuthRole_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async passwordNeedsHash(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.passwordNeedsHash();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AuthRole_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AuthRole): AuthRole {
...
function from_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "owner" in value ? AuthRole.owner : "visitor" in value ? AuthRole.visitor : value;
}
