...
export function createBackup(): void {
  const backupData: BackupData = {
    ...
    portfolioState: {
      ...
      aboutMe: 'Passionate Minecraft server developer with 2.5+ years of experience',
      experience: [
        {
          server: 'Obsidian MC',
          role: 'Developer',
      ...
      skills: [
        ...
        },
        {
          ...
          items: ['Performance tuning', 'Resource management', 'Anti-lag solutions'],
        },
        {
      ...
      availability: 'Available for freelance development and moderator positions',
    },
  };
